...
export default function Products(){
    ...
    useEffect(()=>{
        axios.get("http://localhost:8080/products/products").then(result=>{
          ...
          <div className="container-md ">
            ...
            <table className="table table-bordered table-light"> 
              ...
              {res.map((x) => {
                ...
                <td ><label key={x.productId}>{x.arrivalDate}</label></td>
                <td ><label key={x.productId}>{x.expiryDate}</label></td>
