...
export default function ViewDelivered(){
    ...
    useEffect(()=>{
      axios.get("http://localhost:8080/deliver/getdeliver").then(result=>{
    ...
    const handleDelete=(e)=>{
        e.preventDefault();
          ...
          const url=`http://localhost:8080/deliver/delete/${productId}`
          axios.delete(url)
          .then(res1 => {
            console.log(res1);
    ...
    return(
        <div>
          <div className="container-md ">
            ...
            <div className="card"> 
            <div className="card-header"><h4>DELIVERED PRODUCT LIST</h4></div>
            ...
            <table className="table table-bordered table-light"> 
              ...
              {res.map((x) => {
                ...
                <td ><label key={x.productId}>{x.deliveredDate}</label></td>
